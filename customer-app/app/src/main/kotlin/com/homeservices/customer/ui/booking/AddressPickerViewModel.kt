...
import com.homeservices.customer.di.DefaultDispatcher
...
public class AddressPickerViewModel
    ...
    constructor(
        ...
        private val dragInput = MutableStateFlow<Pair<Double, Double>?>(null)
        ...
        public fun onMarkerDragEnd(
            lat: Double,
            lng: Double,
        ) {
            dragInput.value = Pair(lat, lng)
        }
        ...
        private suspend fun handleDebouncedDrag(
            lat: Double,
            lng: Double,
        ) {
