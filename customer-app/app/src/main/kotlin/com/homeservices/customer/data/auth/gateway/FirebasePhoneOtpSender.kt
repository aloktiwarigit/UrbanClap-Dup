...
@Singleton
public class FirebasePhoneOtpSender
    @Inject
    constructor(
        ...
        public override fun signInWithCredential(credential: PhoneAuthCredential): Flow<AuthResult> =
            callbackFlow {
