...
public class EmailPasswordUseCaseTest {
    ...
    @Test
    public fun `signIn — success — emits Success with FirebaseUser`(): Unit =
        runTest {
    ...
    @Test
    public fun `signIn — FirebaseAuthInvalidCredentialsException WRONG_PASSWORD — emits WrongCredential`(): Unit =
        runTest {
            val ex: FirebaseAuthInvalidCredentialsException =
                mockk(relaxed = true) {
    ...
    @Test
    public fun `signIn — FirebaseAuthInvalidCredentialsException INVALID_EMAIL — emits InvalidEmail`(): Unit =
        runTest {
            val ex: FirebaseAuthInvalidCredentialsException =
                mockk(relaxed = true) {
    ...
    @Test
    public fun `signIn — FirebaseAuthInvalidUserException USER_NOT_FOUND — emits UserNotFound`(): Unit =
        runTest {
            val ex: FirebaseAuthInvalidUserException =
                mockk(relaxed = true) {
    ...
    @Test
    public fun `signUp — success — emits Success`(): Unit =
        runTest {
            val mockUser: FirebaseUser = mockk(relaxed = true)
            val mockAuthResult: AuthResult = mockk { every { user } returns mockUser }
    ...
    @Test
    public fun `signUp — FirebaseAuthUserCollisionException — emits EmailAlreadyInUse`(): Unit =
        runTest {
            val ex: FirebaseAuthUserCollisionException =
                mockk(relaxed = true) {
    ...
    @Test
    public fun `signUp — FirebaseAuthWeakPasswordException — emits WeakPassword`(): Unit =
        runTest {
            val ex: FirebaseAuthWeakPasswordException =
                mockk(relaxed = true) {
    ...
    @Test
    public fun `signUp — FirebaseAuthInvalidCredentialsException INVALID_EMAIL — emits InvalidEmail`(): Unit =
        runTest {
            val ex: FirebaseAuthInvalidCredentialsException =
                mockk(relaxed = true) {
                    every { errorCode } returns "ERROR_INVALID_EMAIL"
    ...
    @Test
    public fun `sendPasswordReset — success — emits Result success`(): Unit =
        runTest {
    ...
    @Test
    public fun `sendPasswordReset — failure — emits Result failure`(): Unit =
        runTest {
