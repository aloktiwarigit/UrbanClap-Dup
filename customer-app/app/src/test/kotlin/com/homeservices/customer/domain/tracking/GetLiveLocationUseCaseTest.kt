...
public class GetLiveLocationUseCaseTest {
    ...
    @Test
    public fun `returns null when TrackingState has no location`(): Unit = runTest {
    ...
    @Test
    public fun `returns LiveLocation when present in TrackingState`(): Unit = runTest {
    ...
    @Test
    public fun `maps multiple emissions`(): Unit = runTest {
