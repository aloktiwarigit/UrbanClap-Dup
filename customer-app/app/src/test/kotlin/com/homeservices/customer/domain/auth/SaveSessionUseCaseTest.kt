...
public class SaveSessionUseCaseTest {
    ...
    @Test
    public fun `save stores uid and phoneLastFour in SessionManager`(): Unit = runTest {
    ...
    @Test
    public fun `saveAnonymousWithPhone signs in anonymously and stores last 4 digits`(): Unit = runTest {
    ...
    @Test
    public fun `saveAnonymousWithPhone returns General error when Firebase throws`(): Unit = runTest {
