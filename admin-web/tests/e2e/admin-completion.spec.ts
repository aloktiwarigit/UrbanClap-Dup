...
test.describe('admin completion role matrix', () => {
  test('super-admin sees enterprise navigation and ops/finance/support are constrained', async ({ page, context, baseURL }) => {
...
test.describe('admin completion workflows', () => {
  ...
  test('catalogue create, edit, service edit, and publish toggle paths work', async ({ page }) => {
    ...
    await page.goto('/catalogue/plumbing/edit');
    ...
    await page.goto('/catalogue/plumbing/services/new');
