...
session id: 019da346-050c-77f3-942c-f6cee8bccdc8
--------
user
...
+# Allow explicit ': Unit' return types (required by -Xexplicit-api=strict + Codex review)
...
Binary files /dev/null and b/customer-app/app/src/test/snapshots/images/com.homeservices.customer.ui_SmokeScreenPaparazziTest_smokeScreenDarkThemeMatchesSnapshot.png differ
...
Binary files /dev/null and b/customer-app/app/src/test/snapshots/images/com.homeservices.customer.ui_SmokeScreenPaparazziTest_smokeScreenLightThemeMatchesSnapshot.png differ
...
+sdk=33
+application=dagger.hilt.android.testing.HiltTestApplication
diff --git a/technician-app/app/src/test/snapshots/images/com.homeservices.technician.ui_SmokeScreenPaparazziTest_smokeScreenDarkThemeMatchesSnapshot.png b/technician-app/app/src/test/snapshots/images/com.homeservices.technician.ui_SmokeScreenPaparazziTest_smokeScreenDarkThemeMatchesSnapshot.png
new file mode 100644
index 0000000..b9b6744
Binary files /dev/null and b/technician-app/app/src/test/snapshots/images/com.homeservices.technician.ui_SmokeScreenPaparazziTest_smokeScreenDarkThemeMatchesSnapshot.png differ
diff --git a/technician-app/app/src/test/snapshots/images/com.homeservices.technician.ui_SmokeScreenPaparazziTest_smokeScreenLightThemeMatchesSnapshot.png b/technician-app/app/src/test/snapshots/images/com.homeservices.technician.ui_SmokeScreenPaparazziTest_smokeScreenLightThemeMatchesSnapshot.png
new file mode 100644
index 0000000..c16ff2c
Binary files /dev/null and b/technician-app/app/src/test/snapshots/images/com.homeservices.technician.ui_SmokeScreenPaparazziTest_smokeScreenLightThemeMatchesSnapshot.png differ
...
A	customer-app/app/src/test/snapshots/images/com.homeservices.customer.ui_SmokeScreenPaparazziTest_smokeScreenDarkThemeMatchesSnapshot.png
A	customer-app/app/src/test/snapshots/images/com.homeservices.customer.ui_SmokeScreenPaparazziTest_smokeScreenLightThemeMatchesSnapshot.png
...
A	technician-app/app/src/test/snapshots/images/com.homeservices.technician.ui_SmokeScreenPaparazziTest_smokeScreenDarkThemeMatchesSnapshot.png
A	technician-app/app/src/test/snapshots/images/com.homeservices.technician.ui_SmokeScreenPaparazziTest_smokeScreenLightThemeMatchesSnapshot.png
...
exec
"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command 'Get-Content -Path customer-app/app/build.gradle.kts -TotalCount 260' in C:\Alok\Business Projects\Urbanclap-dup
exec
"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command 'Get-Content -Path technician-app/app/build.gradle.kts -TotalCount 260' in C:\Alok\Business Projects\Urbanclap-dup
exec
"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command 'Get-Content -Path customer-app/build.gradle.kts; Get-Content -Path technician-app/build.gradle.kts' in C:\Alok\Business Projects\Urbanclap-dup
 succeeded in 477ms:
import org.jetbrains.kotlin.gradle.dsl.JvmTarget
...
2026-04-19T01:06:29.578583Z ERROR codex_core::tools::router: error=`"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "Get-ChildItem -Path customer-app/app/src/main/kotlin -Recurse -Filter *.kt | ForEach-Object { '--- ' + "'$_.FullName; Get-Content $_.FullName }'` rejected: blocked by policy
exec
"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "Get-ChildItem -Path customer-app/app/src/main/kotlin -Recurse -Filter *.kt | ForEach-Object { '--- ' + "'$_.FullName; Get-Content $_.FullName }' in C:\Alok\Business Projects\Urbanclap-dup
 declined in 0ms:
`"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "Get-ChildItem -Path customer-app/app/src/main/kotlin -Recurse -Filter *.kt | ForEach-Object { '--- ' + "'$_.FullName; Get-Content $_.FullName }'` rejected: blocked by policy
exec
"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "Get-ChildItem -Path 'customer-app/app/src/main/kotlin' -Recurse -Filter '*.kt' | Select-Object -ExpandProperty FullName" in C:\Alok\Business Projects\Urbanclap-dup
 succeeded in 348ms:
...
C:\Alok\Business Projects\Urbanclap-dup\customer-app\app\src\main\kotlin\com\homeservices\customer\ui\theme\Color.kt
C:\Alok\Business Projects\Urbanclap-dup\customer-app\app\src\main\kotlin\com\homeservices\customer\ui\theme\Theme.kt
C:\Alok\Business Projects\Urbanclap-dup\customer-app\app\src\main\kotlin\com\homeservices\customer\ui\theme\Type.kt

2026-04-19T01:06:41.861486Z ERROR codex_core::tools::router: error=`"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "Get-Content -Path 'customer-app/app/src/main/kotlin/com/homeservices/customer/HomeservicesCustomerApplication.kt','customer-app/app/src/main/kotlin/com/homeservices/customer/MainActivity.kt','customer-app/app/src/main/kotlin/com/homeservices/customer/di/AppModule.kt','customer-app/app/src/main/kotlin/com/homeservices/customer/di/BuildInfoProvider.kt','customer-app/app/src/main/kotlin/com/homeservices/customer/observability/SentryInitializer.kt','customer-app/app/src/main/kotlin/com/homeservices/customer/ui/SmokeScreen.kt'"` rejected: blocked by policy
exec
"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "Get-Content -Path 'customer-app/app/src/main/kotlin/com/homeservices/customer/HomeservicesCustomerApplication.kt','customer-app/app/src/main/kotlin/com/homeservices/customer/MainActivity.kt','customer-app/app/src/main/kotlin/com/homeservices/customer/di/AppModule.kt','customer-app/app/src/main/kotlin/com/homeservices/customer/di/BuildInfoProvider.kt','customer-app/app/src/main/kotlin/com/homeservices/customer/observability/SentryInitializer.kt','customer-app/app/src/main/kotlin/com/homeservices/customer/ui/SmokeScreen.kt'" in C:\Alok\Business Projects\Urbanclap-dup
exec
"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "Get-Content -Path 'technician-app/app/src/main/kotlin/com/homeservices/technician/HomeservicesTechnicianApplication.kt','technician-app/app/src/main/kotlin/com/homeservices/technician/MainActivity.kt','technician-app/app/src/main/kotlin/com/homeservices/technician/di/AppModule.kt','technician-app/app/src/main/kotlin/com/homeservices/technician/di/BuildInfoProvider.kt','technician-app/app/src/main/kotlin/com/homeservices/technician/observability/SentryInitializer.kt','technician-app/app/src/main/kotlin/com/homeservices/technician/ui/SmokeScreen.kt'" in C:\Alok\Business Projects\Urbanclap-dup
 declined in 0ms:
`"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "Get-Content -Path 'customer-app/app/src/main/kotlin/com/homeservices/customer/HomeservicesCustomerApplication.kt','customer-app/app/src/main/kotlin/com/homeservices/customer/MainActivity.kt','customer-app/app/src/main/kotlin/com/homeservices/customer/di/AppModule.kt','customer-app/app/src/main/kotlin/com/homeservices/customer/di/BuildInfoProvider.kt','customer-app/app/src/main/kotlin/com/homeservices/customer/observability/SentryInitializer.kt','customer-app/app/src/main/kotlin/com/homeservices/customer/ui/SmokeScreen.kt'"` rejected: blocked by policy
 declined in 0ms:
`"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "Get-Content -Path 'technician-app/app/src/main/kotlin/com/homeservices/technician/HomeservicesTechnicianApplication.kt','technician-app/app/src/main/kotlin/com/homeservices/technician/MainActivity.kt','technician-app/app/src/main/kotlin/com/homeservices/technician/di/AppModule.kt','technician-app/app/src/main/kotlin/com/homeservices/technician/di/BuildInfoProvider.kt','technician-app/app/src/main/kotlin/com/homeservices/technician/observability/SentryInitializer.kt','technician-app/app/src/main/kotlin/com/homeservices/technician/ui/SmokeScreen.kt'"` rejected: blocked by policy
2026-04-19T01:06:41.863837Z ERROR codex_core::tools::router: error=`"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "Get-Content -Path 'technician-app/app/src/main/kotlin/com/homeservices/technician/HomeservicesTechnicianApplication.kt','technician-app/app/src/main/kotlin/com/homeservices/technician/MainActivity.kt','technician-app/app/src/main/kotlin/com/homeservices/technician/di/AppModule.kt','technician-app/app/src/main/kotlin/com/homeservices/technician/di/BuildInfoProvider.kt','technician-app/app/src/main/kotlin/com/homeservices/technician/observability/SentryInitializer.kt','technician-app/app/src/main/kotlin/com/homeservices/technician/ui/SmokeScreen.kt'"` rejected: blocked by policy
exec
"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "Get-Content -Path 'customer-app/app/src/main/kotlin/com/homeservices/customer/HomeservicesCustomerApplication.kt'" in C:\Alok\Business Projects\Urbanclap-dup
 succeeded in 264ms:
package com.homeservices.customer
...
exec
"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "Get-Content -Path 'customer-app/app/src/main/kotlin/com/homeservices/customer/di/AppModule.kt'; Get-Content -Path 'customer-app/app/src/main/kotlin/com/homeservices/customer/di/BuildInfoProvider.kt'; Get-Content -Path 'customer-app/app/src/main/kotlin/com/homeservices/customer/observability/SentryInitializer.kt'; Get-Content -Path 'customer-app/app/src/main/kotlin/com/homeservices/customer/ui/SmokeScreen.kt'" in C:\Alok\Business Projects\Urbanclap-dup
 succeeded in 292ms:
package com.homeservices.customer.di
...
exec
"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "Get-Content -Path 'customer-app/app/src/test/kotlin/com/homeservices/customer/HiltWiringTest.kt'; Get-Content -Path 'customer-app/app/src/test/kotlin/com/homeservices/customer/di/BuildInfoProviderTest.kt'; Get-Content -Path 'customer-app/app/src/test/kotlin/com/homeservices/customer/observability/SentryInitializerTest.kt'; Get-Content -Path 'customer-app/app/src/test/kotlin/com/homeservices/customer/ui/SmokeScreenPaparazziTest.kt'" in C:\Alok\Business Projects\Urbanclap-dup
 succeeded in 349ms:
package com.homeservices.customer
...
exec
"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "Get-Content -Path 'customer-app/app/src/main/AndroidManifest.xml'; Get-Content -Path 'customer-app/app/src/androidTest/kotlin/com/homeservices/customer/TestRunner.kt'; Get-Content -Path 'customer-app/app/src/main/kotlin/com/homeservices/customer/ui/theme/Theme.kt'; Get-Content -Path 'customer-app/app/src/main/kotlin/com/homeservices/customer/ui/theme/Color.kt'; Get-Content -Path 'customer-app/app/src/main/kotlin/com/homeservices/customer/ui/theme/Type.kt'" in C:\Alok\Business Projects\Urbanclap-dup
 succeeded in 304ms:
<?xml version="1.0" encoding="utf-8"?>
<manifest xmlns:android="http://schemas.android.com/apk/res/android">
...
exec
"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "Get-Content -Path 'customer-app/gradle/libs.versions.toml'; Get-Content -Path 'customer-app/gradle.properties'" in C:\Alok\Business Projects\Urbanclap-dup
 succeeded in 178ms:
[versions]
# Toolchain
kotlin = "2.0.21"
...
exec
"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "Get-Content -Path 'technician-app/app/src/main/AndroidManifest.xml'; Get-Content -Path 'technician-app/app/src/main/kotlin/com/homeservices/technician/observability/SentryInitializer.kt'; Get-Content -Path 'technician-app/app/src/main/kotlin/com/homeservices/technician/ui/SmokeScreen.kt'" in C:\Alok\Business Projects\Urbanclap-dup
 succeeded in 182ms:
<?xml version="1.0" encoding="utf-8"?>
<manifest xmlns:android="http://schemas.android.com/apk/res/android">
...
exec
"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "Get-Content -Path 'docs/stories/E01-S03-android-app-skeletons.md' -TotalCount 240" in C:\Alok\Business Projects\Urbanclap-dup
 succeeded in 189ms:
# Story E01.S03: Android app skeletons â€” customer-app + technician-app (Kotlin + Compose + Hilt + Paparazzi + Sentry + green CI)

Status: ready-for-dev

> **Epic:** E01 â€” Foundations, CI & Design System (`docs/stories/README.md` Â§E01)
> **Sprint:** S1 (wk 1â€“2) Â· **Estimated:** ~1.5 dev-days (two apps, high task overlap) Â· **Priority:** **P0 / blocks all other `customer-app/` stories (E02-S01, E03-S02, E03-S03, E04-S01..S03, E06-S03, E06-S05, E07-S01, E07-S02, E07-S05) and all `technician-app/` stories (E02-S02, E02-S03, E05-S03, E06-S01, E06-S02, E08-S01..S04) plus E01-S04 (design-system module consumers)**
> **Sub-projects:** `customer-app/` and `technician-app/` (both touched in this one story)
...
As the **solo founder-operator (Alok)** building homeservices-mvp on Claude Max + Codex,
I want both Android sub-projects â€” `customer-app/` and `technician-app/` â€” to be runnable Kotlin 2 + Jetpack Compose + Hilt + Paparazzi + Sentry skeletons, each rendering a trivial "homeservices customer / technician" smoke screen, each producing a debug APK from `./gradlew assembleDebug`, each gated by an independent `customer-ship.yml` / `technician-ship.yml` workflow at the **repo-root** `.github/workflows/`,
so that **every subsequent Android story (auth, service discovery, booking, dispatch, active-job, earnings, complaints, safety) starts from a stable, convention-locked, lint-clean, screenshot-tested, BMAD-gated baseline â€” not two empty `app/src/main/` directories and two dead workflows at sub-project paths.**

This story turns the placeholder agency-baseline scaffolds (both `customer-app/` and `technician-app/` today are literally `app/src/main/` empty trees + a `ship.yml` at a path GitHub Actions never reads + the `docs/`, `plans/`, `specs/` template residue) into two canonical homeservices-mvp Android skeletons aligned with **ADR-0001** (Kotlin 2 + Compose + two separate apps sharing only a Gradle module in a later story), **ADR-0007** (zero paid SaaS â€” no Firebase Crashlytics, no Bugsnag, no Firebase Performance, no Detekt Pro), **architecture Â§5â€“Â§7** (Compose theming conventions + Paparazzi gate + NFR-M-5 `-Werror` + NFR-O-2 Sentry), and the two-disaster-fix pattern already proven in E01-S02 (workflow-at-wrong-path + self-referential codex-marker paradox).

The story deliberately **does NOT** create a shared `design-system/` Gradle module â€” that is E01-S04's job. Each app in this story carries its own minimal placeholder `theme/` package; E01-S04 extracts the shared module and the two apps migrate to it as its first consumers.
...
### AC-1 Â· `./gradlew assembleDebug` succeeds on both apps and produces runnable debug APKs
- **Given** a developer at repo root runs `./gradlew :app:assembleDebug` inside `customer-app/` and separately inside `technician-app/`
- **Then** each Gradle build exits 0 within â‰¤ 5 min cold / â‰¤ 90 s warm on a typical dev machine
- **And** each build emits an APK at `<app>/app/build/outputs/apk/debug/app-debug.apk`
- **And** each APK's `AndroidManifest.xml` declares the correct `applicationId`: `com.homeservices.customer` (customer-app) / `com.homeservices.technician` (technician-app)
- **And** each APK installs (`adb install`) and launches on Android 8.0 (API 26) and Android 15 (API 35) emulators without crashing
- **(NFR-M-5 build-green enforcement; NFR-O-2 Sentry init must not crash on missing DSN)**

### AC-2 Â· Smoke screen renders on launch with correct copy + token-styled theme
- **Given** the debug APK is installed and launched
- **Then** the single activity (`MainActivity`) renders a Compose screen containing:
  - A top-aligned brand string: `"homeservices customer"` (customer-app) / `"homeservices technician"` (technician-app)
  - A subtitle line: `"skeleton â€” ready for development"`
  - A footer showing `version` (from `BuildConfig.VERSION_NAME`, expected `0.1.0`) and `commit` (8-char prefix of `BuildConfig.GIT_SHA` â€” `"dev"` locally, actual commit SHA in CI)
- **And** the screen uses the app's Compose theme (`HomeservicesCustomerTheme` / `HomeservicesTechnicianTheme`) with Material 3 light + dark color schemes that respect the system setting
- **And** no runtime crashes, no Compose recomposition loops, no Sentry events fire during render (verified by Paparazzi snapshot + smoke run)

### AC-3 Â· Kotlin compiles with `-Werror` + explicit API mode + K2 compiler
- **Given** the codebase
- **When** `./gradlew compileDebugKotlin` runs in either app
- **Then** the Kotlin K2 compiler (`languageVersion = 2.0+`) runs with the following strict settings enabled in the app-level `build.gradle.kts`:
  - `allWarningsAsErrors = true` (Kotlin `-Werror` equivalent)
  - `freeCompilerArgs` includes `-Xexplicit-api=strict` (explicit API mode â€” every public declaration requires visibility + return-type annotations)
  - `jvmTarget = JvmTarget.JVM_17`
- **And** the build fails on ANY compiler warning including deprecations, unused imports, and API-stability warnings â€” **not** just errors
- **(NFR-M-5 enforcement for Kotlin, matching the TS `strict: true` + `--max-warnings 0` policy locked for `api/` and `admin-web/`)**

### AC-4 Â· Detekt + ktlint + Android Lint all report zero issues (warnings fail the build)
- **Given** the codebase
- **When** `./gradlew detekt ktlintCheck lintDebug` runs in either app
- **Then** each of the three checks exits 0 with **zero** findings at severity `warning` or above
- **And** `detekt.yml` is committed at each app's root with: `build.maxIssues: 0`, `style.*` enabled, `complexity.*` enabled, `naming.*` enabled, `comments.*` enabled, `potential-bugs.*` enabled; the baseline file is deliberately absent (no suppressions â€” skeleton is clean)
- **And** ktlint follows official Kotlin style (no project-specific overrides this early); invocation via the `org.jlleitschuh.gradle.ktlint` plugin (OSS, Apache-2.0)
- **And** Android Lint runs against `lintDebug` (not `lintRelease` â€” release signing is out of scope) with `warningsAsErrors = true` and `checkDependencies = false`
- **(NFR-M-5 enforcement)**

### AC-5 Â· Hilt is wired end-to-end and proven by a DI smoke test
- **Given** the codebase
- **When** `./gradlew testDebugUnitTest` runs the Hilt wiring test
- **Then** the test asserts that the `HomeservicesCustomerApplication` / `HomeservicesTechnicianApplication` class is annotated `@HiltAndroidApp` and that a trivial `@Inject`-constructed class (`BuildInfoProvider`) can be resolved by a `@HiltAndroidTest`-annotated test using `HiltAndroidRule` + `launchActivity`
- **And** KSP is the Hilt processor (not KAPT â€” KSP is ~2Ã— faster and Google's recommended direction per Hilt 2.51+)
- **And** no `@Module` other than the single application `@InstallIn(SingletonComponent::class) object AppModule` exists at skeleton stage â€” feature modules land in their own stories
- **(Pattern lock for every future Android story â€” per Â§Patterns to Reuse)**

### AC-6 Â· Paparazzi screenshot test passes on the smoke screen
- **Given** the codebase
- **When** `./gradlew verifyPaparazziDebug` runs in either app
- **Then** at minimum one Paparazzi test class exists (`SmokeScreenPaparazziTest`) capturing the smoke screen in both light and dark mode at a pixel-3-default device profile
- **And** golden images are committed under `<app>/app/src/test/snapshots/images/` (Paparazzi's default snapshot dir) â€” the test passes on first run by recording then verifying
- **And** CI runs `verifyPaparazziDebug` (not `recordPaparazziDebug`) â€” any pixel drift fails the PR
- **And** Paparazzi version is `^1.3.5` (the first version that officially supports Compose 1.7 + Kotlin 2.0; older versions throw layoutlib classloader errors on the K2 toolchain)
- **(NFR-A-1 / NFR-U-5 visual-regression floor; matches the Lighthouse+axe floor established for admin-web)**

### AC-7 Â· JUnit 5 + MockK unit tests pass; Kover coverage â‰¥ 80%
- **Given** the codebase
- **When** `./gradlew testDebugUnitTest koverVerify koverXmlReport` runs in either app
- **Then** unit tests exit 0 with Kover coverage thresholds (in `build.gradle.kts` `kover` block): lines â‰¥ 80%, branches â‰¥ 80%, instructions â‰¥ 80%
- **And** the Kover HTML report is written to `<app>/app/build/reports/kover/html/`
- **And** at least these test files exist and pass in each app: `BuildInfoProviderTest.kt` (pure unit â€” no Android framework), `SentryInitializerTest.kt` (verifies no-op when DSN is empty, init-once when set â€” mocks `io.sentry.android.core.SentryAndroid`), `SmokeScreenPaparazziTest.kt` (Paparazzi â€” counts toward coverage of Compose composables)
- **And** Kover explicitly **excludes** generated code (Hilt `Hilt_*`, Compose `ComposableSingletons$*`, `BuildConfig`, `R`, `R$*`) â€” the exclusions are declared in the `kover` DSL block, not via raw regex comments
- **(NFR-M-4 enforcement for Android, matching the Vitest 80% floor on api/ and admin-web/)**

### AC-8 Â· `customer-ship.yml` and `technician-ship.yml` at repo-root `.github/workflows/` are green on a PR to `main`
- **Given** a PR is opened from this story's feature branch (`E01-S03-android-app-skeletons`) to `main`
- **When** GitHub Actions discovers and runs `.github/workflows/customer-ship.yml` and `.github/workflows/technician-ship.yml` (the **two workflows at repo-root** â€” applying the E01-S02 fix verbatim; **not** at `customer-app/.github/...` or `technician-app/.github/...`)
- **Then** each workflow passes every step: BMAD artifacts gate (`exit 1` on missing), `./gradlew ktlintCheck`, `./gradlew detekt`, `./gradlew lintDebug`, `./gradlew testDebugUnitTest`, `./gradlew koverVerify koverXmlReport`, `./gradlew verifyPaparazziDebug`, `./gradlew assembleDebug`, Semgrep SAST (`p/kotlin p/owasp-top-ten p/secrets`), and codex-review marker ancestor-check
- **And** each workflow has a `paths:` filter tightly scoped to its sub-project: customer-ship.yml â†’ `['customer-app/**', '.github/workflows/customer-ship.yml']`; technician-ship.yml â†’ `['technician-app/**', '.github/workflows/technician-ship.yml']` (so unrelated changes to `api/`, `admin-web/`, or the *other* Android app do not spend CI minutes here)
- **And** each workflow sets `defaults.run.working-directory: customer-app` / `technician-app` so `./gradlew` invocations resolve from the sub-project directory while the BMAD-gate `test -f` lookups still use workspace-root paths
- **And** each workflow uses the **ancestor-check + scope-diff** codex-marker pattern (verbatim copy from `.github/workflows/api-ship.yml`) â€” **not** a naive `MARKER_SHA == HEAD_SHA` equality check
- **And** each workflow sets `env.GIT_SHA: ${{ github.sha }}` at job scope so the `BuildConfig.GIT_SHA` injection in the Gradle build picks up the real commit (not `"dev"`) during CI builds
- **And** each workflow uses `gradle/actions/setup-gradle@v4` (Gradle Build Cache enabled via its default behaviour) and `actions/setup-java@v4` pinned to `distribution: temurin, java-version: 21`

### AC-9 Â· Sentry Android SDK initialized with early-return when DSN unset; no OTel in this story
- **Given** the app starts (`Application.onCreate()`)
- **And** `BuildConfig.SENTRY_DSN` (injected from an optional `SENTRY_DSN` env var at build time, empty string default) is the empty string
- **Then** `SentryInitializer.init(application)` returns without calling `SentryAndroid.init { ... }` â€” verified in `SentryInitializerTest.kt` via MockK
- **Given** `BuildConfig.SENTRY_DSN` is a non-empty DSN
- **Then** `SentryAndroid.init { options -> options.dsn = dsn; options.tracesSampleRate = 0.1 }` is called exactly once
- **And** Sentry Android SDK version is `^7` (current major as of 2026-04; supports Compose + Kotlin 2.0)
- **And** `@opentelemetry/*` / `io.opentelemetry.*` / `io.sentry.opentelemetry.*` packages are **NOT** added in this story â€” defer entirely, mirroring the E01-S01 + E01-S02 deferrals. A single TODO comment in `SentryInitializer.kt` points at the future observability story
- **(NFR-O-2 enforcement via Sentry only; NFR-O-6 deferred)**

### AC-10 Â· Project metadata, rename, package ids, README, gitignore hygiene
- **Given** each app's root
- **Then** `<app>/settings.gradle.kts` has `rootProject.name = "homeservices-customer"` / `"homeservices-technician"`
- **And** `<app>/app/build.gradle.kts` defines `namespace = "com.homeservices.customer"` / `"com.homeservices.technician"` and `defaultConfig.applicationId` identical to the namespace (same pattern as the Play Store listing will use)
- **And** `<app>/app/build.gradle.kts` has `defaultConfig.versionCode = 1`, `versionName = "0.1.0"`, `minSdk = 26`, `targetSdk = 35`, `compileSdk = 35`
- **And** `<app>/gradle.properties` has `org.gradle.jvmargs=-Xmx4g -Dfile.encoding=UTF-8`, `org.gradle.caching=true`, `org.gradle.configuration-cache=true`, `android.useAndroidX=true`, `kotlin.code.style=official`
- **And** `<app>/README.md` is rewritten from the template placeholder (`# <Client App> â€” Android`) to the real skeleton README with: 5-line project description, Quick start (`./gradlew assembleDebug`, `./gradlew installDebug`), Test (`./gradlew testDebugUnitTest koverVerify verifyPaparazziDebug`), Lint (`./gradlew ktlintCheck detekt lintDebug`), Conventions block documenting the Compose-only / Hilt-only / tokens-only / `-Werror` rules
- **And** the template residue (`customer-app/docs/`, `customer-app/plans/`, `customer-app/specs/`, `technician-app/docs/`, `technician-app/plans/`, `technician-app/specs/`) is deleted (matching the E01-S02 N1 cleanup)
- **And** root `.gitignore` gains an explicit `# customer-app/` block and `# technician-app/` block covering `<app>/.gradle/`, `<app>/build/`, `<app>/app/build/`, `<app>/local.properties`, `<app>/.idea/`, `<app>/captures/`, `<app>/app/release/`

### AC-11 Â· `local.properties` never committed; no secrets, no keystore, no `google-services.json`
- **Given** the repository
- **Then** `<app>/local.properties` (contains the `sdk.dir` path â€” user-specific) is gitignored for both apps (covered under AC-10 `.gitignore` block)
- **And** **no** signing config block is added to either `app/build.gradle.kts` â€” release signing + keystore + Play Store wiring is out of scope for this skeleton (belongs in a dedicated deploy story)
- **And** **no** `google-services.json` is added to either app â€” Firebase SDK wiring belongs in **E02-S01** (customer auth) and **E02-S02** (technician auth); adding it here introduces config-file rot + false negatives in CI
- **And** Semgrep `p/secrets` does not flag any committed file
- **(NFR-S-9 secrets hygiene)**

### AC-12 Â· Zero paid SaaS dependencies introduced
- **Given** each app's `libs.versions.toml` (Gradle version catalog) + `build.gradle.kts` files + any `settings.gradle.kts` plugin pins
- **Then** every dependency added in this story is OSS (Apache-2.0, MIT, BSD, EPL, or equivalent) and â€” where applicable â€” on the approved free-tier list at `docs/adr/0007-zero-paid-saas-constraint.md` Â§"Known free-tier dependencies"
- **And** the dependency list is documented in Â§Library/Framework Requirements below
- **And** no paid SDK is present: **no** Firebase Crashlytics paid plan, **no** Bugsnag, **no** Instabug, **no** Braze/Airship/Leanplum messaging, **no** Datadog/New Relic Android, **no** AppsFlyer/Adjust attribution, **no** Sentry paid-tier-only features
- **And** ADR-0007 is amended (or its Â§"Known free-tier dependencies" table is augmented) to list every new build/test-time dev dependency introduced by this story (matching the E01-S06 pattern where the ADR was amended rather than replaced)
...
> **TDD discipline (per CLAUDE.md):** every task that introduces production code writes the failing test first, then makes it pass, then refactors. Sub-tasks are ordered for that.
>
> **Two-app execution discipline:** every `T<n>.<m>` below applies to **both** apps unless the sub-task is explicitly prefixed `[customer-app]` or `[technician-app]`. Execute the whole task against `customer-app` first, commit, then repeat against `technician-app` and commit â€” resist the temptation to commit a half-migration. (Per root CLAUDE.md: small commits, no `--amend` on pushed work.)

- [ ] **T1 â€” Project metadata, configs, README, gitignore, template-residue cleanup** (AC-10, AC-11, AC-12)
  - [ ] T1.1 Rewrite each app's `README.md` per AC-10; delete the `# <Client App>` placeholder
  - [ ] T1.2 Delete template residue: `customer-app/docs/`, `customer-app/plans/`, `customer-app/specs/`; same for `technician-app/`
  - [ ] T1.3 Add `# customer-app/` and `# technician-app/` blocks to root `.gitignore` per AC-10
  - [ ] T1.4 Create each app's `.editorconfig` (2-space, LF, UTF-8, trim trailing ws, except `*.kt` / `*.kts` at 4-space per Kotlin convention)
...
- [ ] **T2 â€” Gradle wrapper + version catalog + settings + gradle.properties** (AC-1, AC-3, AC-10)
  - [ ] T2.1 Generate the Gradle wrapper in each app at `gradle/wrapper/gradle-wrapper.properties` pinning Gradle `^8.11` (the first version with stable configuration-cache + K2-compatible AGP handshake)
  - [ ] T2.2 Create each app's `settings.gradle.kts` with `pluginManagement { repositories { gradlePluginPortal(); google(); mavenCentral() } }`, `dependencyResolutionManagement { repositories { google(); mavenCentral() } }`, `rootProject.name = "homeservices-{customer,technician}"`, `include(":app")`
  - [ ] T2.3 Create each app's `gradle/libs.versions.toml` â€” **identical** in both apps at skeleton stage; content lives in Â§Library/Framework Requirements below. Deliberately duplicated across both apps; centralization is a cross-app concern to be handled in a later root-Gradle story (not now, not here â€” stays with two independent Gradle roots)
  - [ ] T2.4 Create each app's `gradle.properties` per AC-10 (jvmargs, caching, configuration-cache, androidx, code.style)
  - [ ] T2.5 Commit (one commit per app)

- [ ] **T3 â€” App-level build.gradle.kts + plugin wiring** (AC-1, AC-3, AC-4, AC-5, AC-6, AC-7, AC-9, AC-10)
  - [ ] T3.1 Create each app's top-level `build.gradle.kts` (repositories + plugin version declarations via `alias(libs.plugins.*)` â€” no logic here; AGP quirk means plugins must be declared at root with `apply false`)
  - [ ] T3.2 Create each app's `app/build.gradle.kts`: plugins (AGP, Kotlin 2, Compose, Hilt, KSP, Kover, Detekt, ktlint, Paparazzi), `android { }` block per AC-10, `buildFeatures { compose = true; buildConfig = true }`, `kotlinOptions` with `-Werror` + explicit-api + JVM_17, `buildConfigField("String", "SENTRY_DSN", "\"${System.getenv("SENTRY_DSN") ?: ""}\"")` + `GIT_SHA` (`System.getenv("GIT_SHA") ?: "dev"`)
  - [ ] T3.3 Wire Kover, Detekt, ktlint, Paparazzi blocks â€” Kover thresholds 80/80/80 with exclusions per AC-7
  - [ ] T3.4 Confirm `./gradlew :app:dependencies` resolves cleanly with **no** unresolved modules â€” no `google-services` plugin, no Firebase plugins (AC-11)

- [ ] **T4 â€” Application + MainActivity + Compose theme + smoke screen** (AC-2, AC-5, AC-9)
  - [ ] T4.1 (RED) Write `SmokeScreenPaparazziTest.kt` under `app/src/test/kotlin/com/homeservices/{customer,technician}/ui/` â€” captures `SmokeScreen()` composable under light + dark themes at `DeviceConfig.PIXEL_5` (or similar); test fails because `SmokeScreen` doesn't exist yet
  - [ ] T4.2 (GREEN) Implement `app/src/main/kotlin/com/homeservices/{customer,technician}/HomeservicesCustomerApplication.kt` / `HomeservicesTechnicianApplication.kt` annotated `@HiltAndroidApp`, `onCreate()` calls `SentryInitializer.init(this)`
  - [ ] T4.3 Implement `MainActivity.kt` (a single `ComponentActivity` annotated `@AndroidEntryPoint`) that `setContent { HomeservicesCustomerTheme { SmokeScreen(buildInfo = viewModel.buildInfo) } }` (technician-app uses `HomeservicesTechnicianTheme` with slightly different copy â€” the brand word differs; no other divergence)
  - [ ] T4.4 Implement `ui/theme/Color.kt`, `Theme.kt`, `Type.kt` â€” minimal Material 3 theme with `LightColorScheme` + `DarkColorScheme` and a body/display typography. **Do not** try to match the UX Â§5 token palette pixel-perfectly here â€” that's E01-S04's job; use Material 3 defaults + one placeholder `brand = Color(0xFF0B5FEE)` swatch to prove the theming path
  - [ ] T4.5 Implement `ui/SmokeScreen.kt` â€” a `@Composable` taking `BuildInfo` and rendering the AC-2 copy; uses only Material 3 + the theme; no user input, no navigation
  - [ ] T4.6 (GREEN) Paparazzi test passes; snapshots committed under `app/src/test/snapshots/images/`
  - [ ] T4.7 `AndroidManifest.xml` declares the application class + MainActivity + `INTERNET` permission only (needed by Sentry; nothing else â€” no FCM, no Firebase, no location, no camera in this story)

- [ ] **T5 â€” Hilt + BuildInfo provider + DI smoke test** (AC-5, AC-7)
  - [ ] T5.1 (RED) Write `BuildInfoProviderTest.kt` â€” pure unit test asserting `BuildInfoProvider(version = "0.1.0", gitSha = "abcdef1234").shortSha == "abcdef12"`
  - [ ] T5.2 (GREEN) Implement `di/BuildInfoProvider.kt` as a constructor-injected class
  - [ ] T5.3 Create `di/AppModule.kt` annotated `@Module @InstallIn(SingletonComponent::class)`; `@Provides` `BuildInfo` built from `BuildConfig.VERSION_NAME` + `BuildConfig.GIT_SHA`
  - [ ] T5.4 (RED â†’ GREEN) Write `HiltWiringTest.kt` annotated `@HiltAndroidTest` with `HiltAndroidRule` that injects `BuildInfoProvider` into the test and asserts non-null
  - [ ] T5.5 Add `HiltTestApplication` shim + `HiltAndroidTestRunner` in `app/src/androidTest/kotlin/.../TestRunner.kt` â€” but run this test under Robolectric so it stays on the JVM and doesn't require an emulator (keep CI cheap; Espresso + real-device tests land in a later story)

- [ ] **T6 â€” Sentry initializer + unit tests** (AC-9, AC-7)
  - [ ] T6.1 (RED) Write `SentryInitializerTest.kt` â€” MockK `io.sentry.android.core.SentryAndroid`; two cases: DSN empty â†’ `init` never called; DSN set â†’ `init` called once with `tracesSampleRate = 0.1`
  - [ ] T6.2 (GREEN) Implement `observability/SentryInitializer.kt` reading `BuildConfig.SENTRY_DSN`; early-return on blank; TODO comment pointing at the future observability story (mirrors `api/bootstrap.ts`)
  - [ ] T6.3 Wire `SentryInitializer.init(this)` into `Application.onCreate()` (already done in T4.2)

- [ ] **T7 â€” Per-app CI workflows at repo-root** (AC-8)
  - [ ] T7.1 `git mv customer-app/.github/workflows/ship.yml .github/workflows/customer-ship.yml` â€” and a separate `git mv technician-app/.github/workflows/ship.yml .github/workflows/technician-ship.yml` (apply the E01-S02 lesson: GitHub Actions only discovers workflows at the repo-root `.github/workflows/`)
  - [ ] T7.2 Rewrite each workflow: `name:`, `paths:` filter scoped to that app only, `defaults.run.working-directory: <app>`, `env: { GIT_SHA: ${{ github.sha }} }`, full step list per AC-8
  - [ ] T7.3 Replace the template's naive codex-marker `MARKER == HEAD` check with the **ancestor-check + scope-diff** block copied verbatim from `.github/workflows/api-ship.yml` (allowed-scope: `.codex-review-passed` + `docs/reviews/**` â€” same as the other two workflows)
  - [ ] T7.4 Add `actions/setup-java@v4` (temurin, 21), `gradle/actions/setup-gradle@v4`, Semgrep step with `config: p/kotlin p/owasp-top-ten p/secrets` (drop the template's `p/ci` â€” it's noisy on GitHub Actions)
  - [ ] T7.5 Delete the now-empty `customer-app/.github/` and `technician-app/.github/` trees (Windows `git mv` may leave empty dirs â€” explicit `git rm -r <empty-dir>` or `rmdir` as needed)
  - [ ] T7.6 Verify both workflows are discovered by GitHub Actions UI after push (not detected pre-push; first PR proves discovery)

- [ ] **T8 â€” ADR sweep + final amend of ADR-0007** (AC-12)
  - [ ] T8.1 Update `docs/adr/0007-zero-paid-saas-constraint.md` Â§"Known free-tier dependencies" table with a new 2026-04-18 "Story E01-S03" amendment block listing every new dev dependency from Â§Library/Framework Requirements (Detekt, ktlint plugin, Paparazzi, Kover, MockK, Robolectric, Hilt, KSP â€” all OSS, Apache-2.0 or MIT) â€” mirror the formatting of the E01-S06 amendment already in that file

- [ ] **T9 â€” Pre-push 5-layer review gate** (per CLAUDE.md Â§Per-Story Protocol)
  - [ ] T9.1 `/code-review` (cheap lint + stylistic pass â€” Claude)
  - [ ] T9.2 `/security-review`
  - [ ] T9.3 `/codex-review-gate` â€” **authoritative**; must produce `.codex-review-passed` keyed to current commit SHA
  - [ ] T9.4 `/bmad-code-review` (Blind Hunter + Edge Case Hunter + Acceptance Auditor)
  - [ ] T9.5 `/superpowers:requesting-code-review`
  - [ ] T9.6 Only after all 5 layers, `git push`
...
This is the **first Android story and the foundation for both Android apps**. Dependencies: E01-S01 merged (âœ“ â€” `33db7bb`); E01-S02 merged (âœ“ â€” PR #2 on main); E01-S06 merged (âœ“ â€” `1bd0706`, OpenAPI client wiring â€” not consumed in this story, but sets the pattern for Android API generation in a later story). Phase gate satisfied (`.bmad-readiness-passed` committed at `c360120`). `app/src/main/` edits now unlocked.

**Why this matters strategically (per architecture Â§2 Boring-Technology Manifesto):** every choice in this story locks in a pattern the next **~20 Android stories** will follow (E02, E03-customer-facing, E04, E05, E06, E07, E08). Getting the Compose theming wrong, the Hilt graph wrong, the Paparazzi wrapper wrong, the Kotlin compile-flags wrong, or either CI workflow location wrong all have 20Ã—-multiplier impact. Get it right and every subsequent Android story moves fast.

**Scope honesty:** this story touches two apps, so it is deliberately larger than E01-S01 or E01-S02. Estimate is **~1.5 dev-days**, not 1. Most sub-tasks apply identically to both apps; executing against `customer-app/` first end-to-end, then repeating the same work in `technician-app/`, is the fastest path â€” treating them as a matrix or trying to abstract over both simultaneously is premature (E01-S04 handles shared code correctly via the `design-system/` Gradle module).

### Critical Architectural Constraints (READ BEFORE CODING)

| Constraint | Source | Story-level implication |
|---|---|---|
| **Kotlin 2.x + Jetpack Compose + Material 3** | ADR-0001, architecture Â§6 | K2 compiler on; Compose compiler plugin via `org.jetbrains.kotlin.plugin.compose`; Material 3 only (no Material 2) |
| **Android minSdk 26 / targetSdk 35 / compileSdk 35** | architecture Â§5.1, PRD Â§Project-Type Specific Requirements | Covers ~95% of Indian Android devices; targets Android 15 |
| **TWO separate Gradle codebases, no root Gradle** | ADR-0001 Consequences â€” "Two Android codebases duplicate some scaffolding" | No `settings.gradle.kts` at repo root; each app is its own Gradle root. Version catalogs duplicated deliberately. |
| **No shared `design-system/` Gradle module yet** | `docs/stories/README.md` Â§E01 â€” E01-S04 row | Each app carries its own minimal `ui/theme` package in THIS story; E01-S04 extracts to a shared module and migrates both apps as first consumers |
| **Kotlin `-Werror` + explicit API mode** | NFR-M-5, root CLAUDE.md | `allWarningsAsErrors = true` + `freeCompilerArgs += "-Xexplicit-api=strict"` â€” matches the TS `strict: true` + ESLint `--max-warnings 0` discipline |
| **Hilt for DI (not Koin, not Dagger-only, not manual)** | Template, architecture implied | Google-recommended; KSP (not KAPT) processor for speed |
| **Paparazzi for screenshot tests (not Roborazzi, not Shot)** | Template, architecture Â§7.1 row NFR-U-5 | CashApp OSS; JVM-only via layoutlib â€” no emulator needed in CI |
| **Sentry only for observability in this story; OTel deferred** | ADR-0007, E01-S01 + E01-S02 precedents | `@opentelemetry/*` NOT added; single TODO comment; observability story lands later |
| **No Firebase SDKs yet** | Scope, threat-model Â§3.3 | Firebase Phone Auth + Truecaller + FCM all land in E02 / E03 stories, each introducing exactly the minimal SDK they need |
| **Zero paid SaaS** | ADR-0007 | Every dep on the approved free-tier/OSS list; ADR-0007 amended with the new dev deps this story adds |
| **Codex review is authoritative gate** | CLAUDE.md, `feedback_cross_model_review.md` | Cannot merge without `.codex-review-passed`; each workflow enforces via ancestor-check + scope-diff |
| **Android CI at repo-root, one workflow per app** | E01-S02 lesson | Two workflows (`customer-ship.yml`, `technician-ship.yml`) mirroring the per-sub-project pattern already set for `api-ship.yml` + `admin-ship.yml` |
...
1. **`paths:` filter coupling** â€” a matrix workflow is one workflow instance per push; GitHub evaluates `paths:` at workflow level, not per-job. Either both app workflows trigger on any Android change, or neither. Two workflows give us independent triggers.
2. **Independent success signal** â€” a matrix job's overall status is green-iff-all-green. Two workflows give two independent status checks on a PR, which is what the review gate wants (`customer-ship` can pass while `technician-ship` is red and vice versa).
3. **Pattern symmetry** â€” `api-ship.yml` and `admin-ship.yml` are each one workflow per sub-project. Two Android workflows mirror that shape. Future contributors find what they expect.
4. **Cost** â€” CI minute delta between matrix and separate workflows is zero when only one app changed; the `paths:` filter skips the untouched workflow entirely.

### Why Paparazzi (Not Roborazzi, Shot, or Compose Preview Screenshots)

exec
"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "Get-Content -Path 'customer-app/detekt.yml' -TotalCount 240" in C:\Alok\Business Projects\Urbanclap-dup
 succeeded in 173ms:
build:
  maxIssues: 0
  excludeCorrectable: false
...
exec
"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "Get-Content -Path '.github/workflows/api-ship.yml' -ErrorAction SilentlyContinue; Get-Content -Path '.github/workflows/admin-ship.yml' -ErrorAction SilentlyContinue" in C:\Alok\Business Projects\Urbanclap-dup
 succeeded in 207ms:
name: api-ship
...
jobs:
  quality-gate:
    ...
    steps:
      ...
      # Remove `|| true` once dep count > ~30 â€” tracked as tech debt in docs/stories/README.md Â§E01.
      ...
      - name: openapi spec is up to date
        run: |
          ...
          if ! git diff --exit-code openapi.json; then
            echo "::error::api/openapi.json is stale â€” run 'pnpm -C api openapi:build' and commit the result (story E01-S06)"
            exit 1
          fi
      ...
      - name: codex review marker (authoritative gate)
        ...
        run: |
          if [ ! -f .codex-review-passed ]; then
            echo "::error::.codex-review-passed marker missing â€” run /codex-review-gate before pushing"
            exit 1
          fi
          MARKER_SHA=$(jq -r .commit .codex-review-passed)
          HEAD_SHA=$(git rev-parse HEAD)
          # The marker records the SHA that Codex reviewed. Committing the marker itself
          # moves HEAD forward, so a strict marker==HEAD check is a chicken-and-egg paradox
          # (the commit that introduces the marker cannot contain its own SHA). Instead,
          # require the marker SHA to be an ancestor of HEAD and verify that nothing
          # outside the marker/review-log scope has changed since Codex reviewed.
          if ! git merge-base --is-ancestor "$MARKER_SHA" "$HEAD_SHA"; then
            echo "::error::marker SHA $MARKER_SHA is not an ancestor of HEAD ($HEAD_SHA) â€” rerun /codex-review-gate"
            exit 1
          fi
          DISALLOWED=$(git diff --name-only "$MARKER_SHA" "$HEAD_SHA" \
            | grep -Ev '^(\.codex-review-passed|docs/reviews/)' || true)
...
on:
  pull_request:
    ...
    paths:
      ...
      - '.codex-review-passed'
      - 'docs/reviews/**'
      # The e2e job boots api/ via playwright webServer, so api runtime
      # changes must re-trigger this workflow (story E01-S06).
      - 'api/openapi.json'
      - 'api/src/**'
      - 'api/package.json'
      - 'api/pnpm-lock.yaml'
    ...
    steps:
      ...
      - name: BMAD artifacts present
        ...
        run: |
          ...
          test -n "$(ls docs/adr/*.md 2>/dev/null | grep -v TEMPLATE)" || { echo "::error::no ADRs in docs/adr/"; exit 1; }
          test -n "$(ls docs/stories/*.md 2>/dev/null)" || { echo "::error::no stories in docs/stories/"; exit 1; }

      - run: pnpm install --frozen-lockfile

      # Gate split: this step only checks admin-web/src/api/generated/** drift.
      # Spec drift (api/openapi.json vs api/src/schemas/**) is gated by
      # api-ship.yml â€” which triggers on api/ changes, and any api change also
      # triggers this workflow (see paths above), so both gates fire together.
      - name: generated api client is up to date
        run: |
          pnpm run openapi:client
          if ! git diff --exit-code src/api/generated/; then
            echo "::error::admin-web/src/api/generated/ is stale â€” run 'pnpm -C admin-web openapi:client' and commit the result (story E01-S06)"
            exit 1
          fi
      ...
      - name: storybook static build
        run: pnpm storybook:build && test -s storybook-static/index.html

      # NOTE: `|| true` kept deliberately for the skeleton (lean dep set; no audit signal yet).
      # Remove once dep count > ~30 â€” tracked in docs/stories/README.md Â§E01.
      - run: pnpm audit --audit-level=high || true
      ...
      - name: codex review marker (authoritative gate)
        ...
        run: |
          ...
          MARKER_SHA=$(jq -r .commit .codex-review-passed)
          HEAD_SHA=$(git rev-parse HEAD)
          # Marker records the SHA Codex reviewed. Committing the marker moves HEAD,
          # so a strict marker==HEAD check is a chicken-and-egg paradox. Require the
          # marker SHA to be an ancestor of HEAD and verify nothing outside the
          # marker/review-log scope changed since Codex reviewed.
          if ! git merge-base --is-ancestor "$MARKER_SHA" "$HEAD_SHA"; then
            echo "::error::marker SHA $MARKER_SHA is not an ancestor of HEAD ($HEAD_SHA) â€” rerun /codex-review-gate"
            exit 1
          fi
  ...
  e2e-and-a11y:
    ...
    steps:
      ...
      - name: install admin-web deps
        run: pnpm install --frozen-lockfile
      - name: install api deps (for playwright webServer â€” story E01-S06)
        working-directory: api
        run: pnpm install --frozen-lockfile
      - name: build api (for func start in playwright webServer)
        working-directory: api
        run: pnpm build
      - name: cache playwright browsers
        ...
        with:
          ...
          key: playwright-${{ runner.os }}-${{ hashFiles('admin-web/pnpm-lock.yaml') }}
...
exec
"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "Get-Content -Path 'customer-app/app/src/main/res/values/themes.xml'; Get-Content -Path 'customer-app/app/src/main/res/xml/data_extraction_rules.xml'; Get-Content -Path 'customer-app/app/src/main/res/drawable/ic_launcher_foreground.xml'; Get-Content -Path 'customer-app/app/src/main/res/mipmap-anydpi/ic_launcher.xml'" in C:\Alok\Business Projects\Urbanclap-dup
 succeeded in 187ms:
<?xml version="1.0" encoding="utf-8"?>
<resources xmlns:tools="http://schemas.android.com/tools">
    <style name="Theme.HomeservicesCustomer" parent="android:Theme.Material.Light.NoActionBar" />
...
exec
"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command 'git diff --check 1bd07063b0325628316b44067adf677a3ef671b1' in C:\Alok\Business Projects\Urbanclap-dup
 succeeded in 210ms:
2026-04-19T01:08:44.264084Z ERROR codex_core::tools::router: error=`"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "Select-String -Path 'customer-app/app/src/**/*.kt','technician-app/app/src/**/*.kt' -Pattern 'customer|technician'"` rejected: blocked by policy
exec
"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "Select-String -Path 'customer-app/app/src/**/*.kt','technician-app/app/src/**/*.kt' -Pattern 'customer|technician'" in C:\Alok\Business Projects\Urbanclap-dup
 declined in 0ms:
`"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "Select-String -Path 'customer-app/app/src/**/*.kt','technician-app/app/src/**/*.kt' -Pattern 'customer|technician'"` rejected: blocked by policy
2026-04-19T01:08:47.530399Z ERROR codex_core::tools::router: error=`"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "git grep -n \"com.homeservices.customer\\|com.homeservices.technician\\|homeservices customer\\|homeservices technician\" -- customer-app technician-app"` rejected: blocked by policy
exec
"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "git grep -n \"com.homeservices.customer\\|com.homeservices.technician\\|homeservices customer\\|homeservices technician\" -- customer-app technician-app" in C:\Alok\Business Projects\Urbanclap-dup
 declined in 0ms:
`"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "git grep -n \"com.homeservices.customer\\|com.homeservices.technician\\|homeservices customer\\|homeservices technician\" -- customer-app technician-app"` rejected: blocked by policy
2026-04-19T01:08:50.586713Z ERROR codex_core::tools::router: error=`"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command 'git grep -n "com.homeservices.customer" -- customer-app'` rejected: blocked by policy
exec
"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command 'git grep -n "com.homeservices.customer" -- customer-app' in C:\Alok\Business Projects\Urbanclap-dup
 declined in 0ms:
`"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command 'git grep -n "com.homeservices.customer" -- customer-app'` rejected: blocked by policy
exec
"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "Select-String -Path 'customer-app/app/src/main/kotlin/com/homeservices/customer/MainActivity.kt' -Pattern 'customer'" in C:\Alok\Business Projects\Urbanclap-dup
 succeeded in 245ms:

customer-app\app\src\main\kotlin\com\homeservices\customer\MainActivity.kt:1:package com.homeservices.customer
customer-app\app\src\main\kotlin\com\homeservices\customer\MainActivity.kt:6:import 
com.homeservices.customer.di.BuildInfoProvider
customer-app\app\src\main\kotlin\com\homeservices\customer\MainActivity.kt:7:import 
com.homeservices.customer.ui.SmokeScreen
customer-app\app\src\main\kotlin\com\homeservices\customer\MainActivity.kt:8:import 
com.homeservices.customer.ui.theme.HomeservicesCustomerTheme
customer-app\app\src\main\kotlin\com\homeservices\customer\MainActivity.kt:20:            HomeservicesCustomerTheme {



2026-04-19T01:09:36.668924Z ERROR codex_core::tools::router: error=`"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "@'
from pathlib import Path
p=Path('customer-app/app/src/main/kotlin/com/homeservices/customer/ui/SmokeScreen.kt')
s=p.read_text(encoding='utf-8')
for line in s.splitlines():
    if 'skeleton' in line or 'version' in line:
        print(repr(line))
...
for line in s.splitlines():
    if 'skeleton' in line or 'version' in line:
        print(repr(line))
'@ | python -"` rejected: blocked by policy
2026-04-19T01:09:42.700628Z ERROR codex_core::tools::router: error=`"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "python -c \"from pathlib import Path; s=Path('customer-app/app/src/main/kotlin/com/homeservices/customer/ui/SmokeScreen.kt').read_text(encoding='utf-8'); [print(repr(line)) for line in s.splitlines() if 'skeleton' in line or 'version' in line]\""` rejected: blocked by policy
exec
"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "python -c \"from pathlib import Path; s=Path('customer-app/app/src/main/kotlin/com/homeservices/customer/ui/SmokeScreen.kt').read_text(encoding='utf-8'); [print(repr(line)) for line in s.splitlines() if 'skeleton' in line or 'version' in line]\"" in C:\Alok\Business Projects\Urbanclap-dup
 declined in 0ms:
`"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "python -c \"from pathlib import Path; s=Path('customer-app/app/src/main/kotlin/com/homeservices/customer/ui/SmokeScreen.kt').read_text(encoding='utf-8'); [print(repr(line)) for line in s.splitlines() if 'skeleton' in line or 'version' in line]\""` rejected: blocked by policy
2026-04-19T01:09:46.509840Z ERROR codex_core::tools::router: error=`"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "Format-Hex -Path 'customer-app/app/src/main/kotlin/com/homeservices/customer/ui/SmokeScreen.kt' | Select-Object -First 20"` rejected: blocked by policy
exec
"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "Format-Hex -Path 'customer-app/app/src/main/kotlin/com/homeservices/customer/ui/SmokeScreen.kt' | Select-Object -First 20" in C:\Alok\Business Projects\Urbanclap-dup
 declined in 0ms:
`"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "Format-Hex -Path 'customer-app/app/src/main/kotlin/com/homeservices/customer/ui/SmokeScreen.kt' | Select-Object -First 20"` rejected: blocked by policy
exec
"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "findstr /n \"skeleton\" \"customer-app\\app\\src\\main\\kotlin\\com\\homeservices\\customer\\ui\\SmokeScreen.kt\"" in C:\Alok\Business Projects\Urbanclap-dup
 succeeded in 192ms:
43:                    text = "skeleton — ready for development",

exec
"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "findstr /n \".*\" \".github\\workflows\\customer-ship.yml\"" in C:\Alok\Business Projects\Urbanclap-dup
 succeeded in 177ms:
1:name: customer-ship
2:
3:on:
4:  pull_request:
5:    branches: [main]
6:    paths:
7:      - 'customer-app/**'
8:      - '.github/workflows/customer-ship.yml'
9:      - '.codex-review-passed'
10:  push:
11:    branches: [main]
12:    paths:
13:      - 'customer-app/**'
14:      - '.github/workflows/customer-ship.yml'
15:      - '.codex-review-passed'
16:
17:concurrency:
...
28:    defaults:
29:      run:
30:        working-directory: customer-app
31:
32:    steps:
...
43:
44:      - name: BMAD artifacts present
45:        working-directory: ${{ github.workspace }}
46:        run: |
47:          for f in docs/prd.md docs/architecture.md docs/ux-design.md docs/threat-model.md docs/runbook.md .bmad-readiness-passed; do
48:            test -f "$f" || { echo "::error::missing $f"; exit 1; }
49:          done
50:
51:      - name: libs.versions.toml drift check
52:        working-directory: ${{ github.workspace }}
53:        run: |
54:          if ! diff -q customer-app/gradle/libs.versions.toml technician-app/gradle/libs.versions.toml > /dev/null; then
55:            echo "::error::libs.versions.toml drifted between customer-app and technician-app"
56:            diff customer-app/gradle/libs.versions.toml technician-app/gradle/libs.versions.toml
57:            exit 1
58:          fi
59:          echo "catalog-drift check OK"
60:
61:      - name: ktlint
62:        run: ./gradlew ktlintCheck
63:
64:      - name: detekt
65:        run: ./gradlew detekt
66:
67:      - name: android lint (debug)
68:        run: ./gradlew lintDebug
69:
70:      - name: unit tests
71:        run: ./gradlew testDebugUnitTest
72:
73:      - name: kover coverage (≥80%)
74:        run: ./gradlew koverVerify koverXmlReport
75:
76:      - name: paparazzi screenshot diff
77:        run: ./gradlew verifyPaparazziDebug
78:
79:      - name: assemble debug APK
80:        run: ./gradlew assembleDebug
81:
82:      - name: semgrep SAST
83:        uses: returntocorp/semgrep-action@v1
84:        with:
85:          config: p/kotlin p/owasp-top-ten p/secrets
86:
87:      - name: codex-review marker verification
88:        if: github.event_name == 'pull_request'
89:        working-directory: ${{ github.workspace }}
90:        run: |
91:          if [ ! -f .codex-review-passed ]; then
92:            echo "::error::.codex-review-passed marker missing — run /codex-review-gate before pushing"
93:            exit 1
94:          fi
95:          MARKER_SHA=$(jq -r .commit .codex-review-passed)
96:          # On pull_request events, actions/checkout@v4 checks out the synthetic
97:          # merge commit, which would make `git rev-parse HEAD` include main-branch
98:          # changes since the marker was created. Use the PR head SHA instead so
99:          # the scope-diff only compares against the PR's own commits.
100:          HEAD_SHA="${{ github.event.pull_request.head.sha || github.sha }}"
101:
102:          # marker SHA must be an ancestor of HEAD and nothing outside the
103:          # allowed scope (.codex-review-passed or docs/reviews/**) may have
104:          # changed since the marker commit
105:          if ! git merge-base --is-ancestor "$MARKER_SHA" "$HEAD_SHA"; then
106:            echo "::error::marker SHA $MARKER_SHA is not an ancestor of HEAD ($HEAD_SHA) — rerun /codex-review-gate"
107:            exit 1
108:          fi
109:
110:          DISALLOWED=$(git diff --name-only "$MARKER_SHA" "$HEAD_SHA" \
111:            | grep -Ev '^(\.codex-review-passed|docs/reviews/)' || true)
112:          if [ -n "$DISALLOWED" ]; then
113:            echo "::error::files outside Codex review scope changed since marker $MARKER_SHA:"
114:            echo "$DISALLOWED"
115:            echo "::error::rerun /codex-review-gate to re-review the new changes"
116:            exit 1
117:          fi
118:          echo "codex-review marker valid: reviewed=$MARKER_SHA head=$HEAD_SHA"

2026-04-19T01:10:47.157884Z ERROR codex_core::tools::router: error=`"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "findstr /n \"0.1\" \"customer-app\\app\\src\\test\\kotlin\\com\\homeservices\\customer\\observability\\SentryInitializerTest.kt\" & findstr /n \"0.1\" \"technician-app\\app\\src\\test\\kotlin\\com\\homeservices\\technician\\observability\\SentryInitializerTest.kt\""` rejected: blocked by policy
exec
"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "findstr /n \"0.1\" \"customer-app\\app\\src\\test\\kotlin\\com\\homeservices\\customer\\observability\\SentryInitializerTest.kt\" & findstr /n \"0.1\" \"technician-app\\app\\src\\test\\kotlin\\com\\homeservices\\technician\\observability\\SentryInitializerTest.kt\"" in C:\Alok\Business Projects\Urbanclap-dup
 declined in 0ms:
`"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "findstr /n \"0.1\" \"customer-app\\app\\src\\test\\kotlin\\com\\homeservices\\customer\\observability\\SentryInitializerTest.kt\" & findstr /n \"0.1\" \"technician-app\\app\\src\\test\\kotlin\\com\\homeservices\\technician\\observability\\SentryInitializerTest.kt\""` rejected: blocked by policy
exec
"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "findstr /n \"0.1\" \"customer-app\\app\\src\\test\\kotlin\\com\\homeservices\\customer\\observability\\SentryInitializerTest.kt\"" in C:\Alok\Business Projects\Urbanclap-dup
 succeeded in 216ms:
80:        assertThat(capturedOptions.tracesSampleRate).isEqualTo(0.1)

exec
"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "findstr /n \"0.1\" \"technician-app\\app\\src\\test\\kotlin\\com\\homeservices\\technician\\observability\\SentryInitializerTest.kt\"" in C:\Alok\Business Projects\Urbanclap-dup
 succeeded in 179ms:
80:        assertThat(capturedOptions.tracesSampleRate).isEqualTo(0.1)

codex
The Android CI workflows run detekt, and the current tests introduce a MagicNumber violation in both app skeletons. This blocks the quality gates from passing until the literal is replaced or configured appropriately.

Review comment:

- [P1] Replace the literal sample rate to keep detekt green — C:\Alok\Business Projects\Urbanclap-dup\customer-app\app\src\test\kotlin\com\homeservices\customer\observability\SentryInitializerTest.kt:80-80
  With the committed `detekt.yml`, `MagicNumber` is active and only `-1`, `0`, `1`, and `2` are ignored; the default `detekt` task analyzes `src/test/kotlin`, so this assertion's `0.1` literal is reported and `./gradlew detekt` exits non-zero. The mirrored technician test has the same literal, so both ship workflows will fail unless this reuses a named constant or the value is otherwise excluded.
The Android CI workflows run detekt, and the current tests introduce a MagicNumber violation in both app skeletons. This blocks the quality gates from passing until the literal is replaced or configured appropriately.
