    ...
    constructor(
        ...
        override suspend fun uploadPhoto(
            ...
            runCatching {
                ...
                // Now that bytes are safely in Firebase Storage, delete the local file from
                // filesDir to prevent unbounded accumulation. runCatching keeps the upload
                // result clean — a failed cleanup must not surface as an upload failure.
