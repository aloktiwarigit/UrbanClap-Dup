    ...
    constructor(
        ...
        override suspend fun uploadPhoto(
            ...
            runCatching {
                ...
                // Local-file cleanup is deferred to the orchestrating use case so it only
                // runs once BOTH this upload and recordPhotoPath succeed — otherwise a
                // transient API failure after a successful Storage upload would leave the
                // retry path without a source file to decode.
        ...
        override fun deleteLocalPhoto(localFilePath: String) {
            // runCatching: a failed cleanup must never surface as a caller-visible error.
