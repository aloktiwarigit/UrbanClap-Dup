    ...
    when (val state = uiState) {
        is ComplaintUiState.Success -> {
            Column(
                ...
                Text(text = "समस्या दर्ज हो गई।", style = MaterialTheme.typography.headlineSmall)
                Spacer(modifier = Modifier.height(8.dp))
                Text(text = "मालिक 2 घंटे में जवाब देंगे।", style = MaterialTheme.typography.bodyMedium)
                Spacer(modifier = Modifier.height(24.dp))
                Button(onClick = onBack) { Text(text = "वापस जाएं") }
            }
        }
        ...
        is ComplaintUiState.Error -> {
            Column(
                ...
                Text(text = "त्रुटि: ${state.message}", color = MaterialTheme.colorScheme.error)
                Spacer(modifier = Modifier.height(16.dp))
                Button(onClick = { viewModel.onReasonSelected(TechComplaintReason.OTHER) }) {
        ...
        is ComplaintUiState.Idle -> {
            ...
            Column(
                ...
                Text(text = "समस्या रिपोर्ट करें", style = MaterialTheme.typography.headlineSmall)
