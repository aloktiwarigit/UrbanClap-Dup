...
/**
 * Unit tests for [FirebaseTokenAuthenticator] (technician-app variant).
 *
...
public class FirebaseTokenAuthenticatorTest {
    ...
    public fun setUp() {
        ...
        every { tokenResult.token } returns "fresh-tech-token-xyz"
    ...
    public fun `authenticate returns request with new Bearer token on first 401`() {
        ...
        assertThat(result!!.header("Authorization")).isEqualTo("Bearer fresh-tech-token-xyz")
